  ...
  <div class="container_responsive_wrapper container_hg pages_rightside">
      <div class="md_screen flex_item">
         ...
         <ul class="links" ref="MdNav">
            <li class="links_par">
               <nuxt-link to="/admin/users"> <i class="fa fa-users"></i> المستخدمين</nuxt-link>
            </li>
            ...
            <li class="links_par">
               <nuxt-link to="/admin/lights"> <i class="fa fa-lightbulb"></i> الإضاءات</nuxt-link>
            </li>
            <li class="links_par">
               <nuxt-link to="/admin/articles"> <i class="fa fa-newspaper"></i> المقالات</nuxt-link>
            </li>
         </ul>
   </div>
</template>
