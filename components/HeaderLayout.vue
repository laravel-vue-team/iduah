   ...
   <header class='header_container'>
      ...
      <div class="main_links">
         ...
         <nav class="header_navbar_lg">
            <ul class="navber_par">
               <div class="no-user" v-if="show">
                  <li class="link_li">
                     <nuxt-link to="/register">حساب جديد</nuxt-link>
                  </li>
                  <li class="link_li log_in">
                     <nuxt-link to="/login" class="transition"><i class="far fa-user"></i> تسجيل الدخول</nuxt-link>
                  </li>
               </div>
               <div class="user" v-if="!show">
                  ...
                  <li class="link_li">
                     <nuxt-link to="/settings"><i class="fa fa-cog"></i>الاعدادت</nuxt-link>
                  </li>
                  <li class="link_li logout">
                     <nuxt-link to="/logout"><i class="fas fa-sign-out-alt"></i>خروج</nuxt-link>
                  </li>
               </div>
            </ul>
...
.header_container{
   ...
   .header_box{
      ...
      .btn_nav_md{
         ...
         height: 35px;
         cursor: pointer;
         @media screen and(min-width: 480px){display: none;}
         .menu_icon{
            width: 100%;
            height: 2px;
