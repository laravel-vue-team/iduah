<template>
   <div class="new_light_container">
      ...
      <form class="light_form" v-show="show">
         <p class="content">
            شاركنا الاجر في اضافة إضاءة جديدة
         </p>
         <textarea name="light" id="new_light" placeholder="بسم الله" required autocomplete="off" spellcheck="off" autocorrect="off" class="focus_elem transition"></textarea>
