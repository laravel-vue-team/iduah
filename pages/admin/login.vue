      ...
      <div class="log_box">
         ...
         <form class="log-form" @submit.prevent="loginUser" ref="loging">
            ...
            <div class="form_group">
               ...
               <input type="password" name="pass" id="pass" placeholder="••••••••" required autocorrect="off" autocomplete="off" spellcheck="off"  class="transition focus_elem">
            </div>

            <div class="form_group">
               <label for="check" class="checkbox">
               <input type="checkbox" name="rememeber" id="check" class="transition focus_elem">
               تذكرني
               </label>
            </div>
            <div class="form_group">
               <button class="btn_submit trasistion"  name="submit" type="submit" @click="CheckRequires">دخول</button>
            </div>
         </form>
      </div>
   </div>
   ...
   export default {
      ...
      data() {
         return {
            requires: false,
            title: 'تسجيل الدخول',
            desc: 'قم بتسجيل الدخول الان واستكمل مهمتك في ادارة موقعك'
         }
      },
      methods: {
         loginUser(){
