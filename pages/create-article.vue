<template>
   <div class="container_responsive_wrapper container_hg create_container">
      <div class="create_box">
         ...
         <p class="error_content transition" v-show="requires">رجاءَ قم بملىء البيانات المطلوبة</p>

         <form class="create-form" @submit.prevent="CreateArticle" ref="create">
            <div class="form_group">
            <label for="title">عنوان المقال <span class="required">*</span></label>
               <input type="text" name="title" id="title" placeholder="..." autocomplete="off" autocorrect="off" spellcheck="off" required class="transition focus_elem">
            </div>
            <div class="form_group">
               <label for="center">القسم  <span class="required">*</span></label>
               <select name="center" id="center" class="focus_elem transition" required spellcheck="off" autocomplete="off">
            ...
            <div class="form_group">
               ...
               <textarea name="content" id="content" placeholder=".." class="focus_elem transition" required spellcheck="off" autocomplete="off"></textarea>
            </div>
            
            <div class="form_group">
               <button class="btn_submit trasistion"  name="submit" type="submit" @click="CheckRequires">أنشر الآن</button>
            </div>
         </form>
      </div>
   </div>
      ...
      methods: {
         CreateArticle(){
            ...
            const db = {
               ...
               center: CurrentSubmitForm['center'].value,
               content: CurrentSubmitForm['content'].value,
