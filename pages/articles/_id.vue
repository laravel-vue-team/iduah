              ...
              <li class="share_li">
                <a
                  :href="
                    ...
                    encodeURI(loc.origin + '/articles/' + $route.params.id)
                  "
                  class="social_icon"
                  target="_blank"
                ...
                <a
                  :href="
                    encodeURI(
                      `https://wa.me/?text=${
                        articles[$route.params.id].content
                      } ${loc.origin}/articles/${$route.params.id}`
                    )
                  "
                  class="social_icon"
                  target="_blank"
...
export default {
  ...
  head() {
    return {
      title:
        this.articles[this.id].user.name + " | " + this.articles[this.id].title,
      meta: [
        {
          hid: "description",
          name: "description",
