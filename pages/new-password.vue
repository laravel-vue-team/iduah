<template>
   <div class="container_responsive_wrapper container_hg password_container">
      <div class="password_box">
         ...
         <form class="password-form" @submit.prevent="ForgotPassword" ref="password">
            ...
            <div class="form_group">
               <button class="btn_submit trasistion"  name="submit" type="submit" @click="CheckRequires">ارسال</button>
            </div>
         </form>
      </div>
   </div>
